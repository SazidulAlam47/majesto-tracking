...
export function TaskTable() {
    ...
    return (
        <div className="space-y-4">
                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="text-xs text-slate-500 uppercase bg-slate-50 border-b border-slate-200">
                            <tr>
                                ...
                                <th className="px-6 py-4 font-medium min-w-75">
                                    <div className="flex items-center gap-2">
                                ...
                                tasks.map((task) => (
                                    ...
                                    >
                                        <td className="px-6 py-4">
                                            <div className="font-medium text-slate-700 bg-slate-50 inline-block px-3 py-1.5 rounded-lg border border-slate-200">
                                        ...
                                        <td className="px-6 py-4">
                                            <ul className="space-y-1.5 text-slate-700">
                                                {task.tasks.map((t, i) => (
                                                    ...
                                                    >
                                                        <span className="text-indigo-600 mt-1 text-xs font-mono">
                                                            {i + 1}.
                                                        </span>
                                                        <span>{t}</span>
                                                    </li>
                                            ...
                                            <div className="flex flex-col gap-2">
                                                {task.images &&
                                                    task.images.length > 0 && (
                                                        <Badge
                                                            variant="secondary"
                                                            className="bg-indigo-50 text-indigo-700 border-indigo-200 cursor-pointer hover:bg-indigo-100 w-fit"
                                                            onClick={() =>
                                                                setSelectedImages(
                                                                    task.images!,
                                                                )
            ...
            {/* Pagination */}
            {totalPages > 1 && (
                <div className="flex items-center justify-between bg-white p-4 rounded-xl border border-slate-200 shadow-sm shadow-slate-200/50">
                    <Button
                        variant="outline"
                        size="sm"
            ...
            >
                <DialogContent className="bg-white border-slate-200 text-slate-900 max-w-4xl">
                    <DialogHeader>
